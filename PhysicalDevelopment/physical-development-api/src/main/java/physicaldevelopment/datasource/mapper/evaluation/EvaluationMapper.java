...
public interface EvaluationMapper {
	...
	public void insertEvaluation(@Param("dailyNutrientAmountId") DailyNutrientAmountId dailyNutrientAmountId, @Param("evaluation") Evaluation evaluation);

	public void updateNotSubjectToEvaluation(@Param("dailyNutrientAmountId") DailyNutrientAmountId dailyNutrientAmountId,
			@Param("notSubjectToEvaluation") NotSubjectToEvaluation notSubjectToEvaluation);

	public Integer existEvaluation(@Param("dailyNutrientAmountId") DailyNutrientAmountId dailyNutrientAmountId);

	public Evaluation selectEvaluation(@Param("dailyNutrientAmountId") DailyNutrientAmountId dailyNutrientAmountId);
...
//	public void upsertEvaluation(@Param("dailyNutrientAmountId") DailyNutrientAmountId dailyNutrientAmountId, @Param("evaluation") Evaluation evaluation);
